...
const Cs2Tournaments = () => {
	...
	const games = ['CS2', 'PUBGM', 'MLBB', 'DOTA 2', 'YANA']
	...
	const tournaments = [
		...
		// Add more CS2 tournaments here
	]

	const getHeroText = () => {
		switch (language) {
			case 'uz':
				return "HAR BIR O'Q – IMKONIYAT, HAR BIR HARAKAT – NATIJA!1"
			case 'ru':
	...
	const getHeaderText = () => {
		switch (language) {
			case 'uz':
				return "CS2 TURNIRLAR"
			case 'ru':
				return "CS2 ТУРНИРЫ"
			case 'en':
				return "CS2 TOURNAMENTS"
			default:
				return "CS2 TURNIRLAR"
		}
	}
