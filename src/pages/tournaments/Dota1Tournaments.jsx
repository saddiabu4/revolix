...
const Dota1Tournaments = () => {
	const { language } = useLanguage()
	const location = useLocation()
	const [activeGame, setActiveGame] = useState('DOTA 1')
	...
	const games = ['DOTA 1', 'PUBGM', 'MLBB', 'DOTA 2', 'YANA']

	const tournaments = [
		{
			id: 1,
			title: "DOTA 1 Pro League Season 2",
			game: "DOTA 1",
			date: "15.04.2025",
			time: "18:00",
			prize: "250$",
		...
		// Add more DOTA 1 tournaments here
	]

	const getHeroText = () => {
		switch (language) {
			case 'uz':
				return "HAR BIR O'Q – IMKONIYAT, HAR BIR HARAKAT – NATIJA!2"
			case 'ru':
	...
	const getHeaderText = () => {
		switch (language) {
			case 'uz':
				return "DOTA 1 TURNIRLAR"
			case 'ru':
				return "DOTA 1 ТУРНИРЫ"
			case 'en':
				return "DOTA 1 TOURNAMENTS"
			default:
				return "DOTA 1 TURNIRLAR"
		}
	}
...
export default Dota1Tournaments 