...
const News = () => {
    ...
    const news = [
        {
            id: 1,
            title: "PUBGM yangi yangilanishi chiqdi",
        ...
        {
            id: 2,
            title: "CS2 jahon chempionati boshlanmoqda",
        ...
        {
            id: 3,
            title: "MLBB yangi qahramon e'lon qilindi",
            category: "game-updates",
            date: "05.05.2025",
            author: "Game News",
            image: "https://via.placeholder.com/300x200"
        ...
        {
            id: 5,
            title: "VALORANT yangi agent e'lon qilindi",
            category: "game-updates",
            date: "25.04.2025",
            author: "Game News",
            image: "https://via.placeholder.com/300x200"
                    ...
                    {news.map((item) => (
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <h3 className="text-[#FF9600] font-bold text-xl mb-4">{item.title}</h3>
                                <Link 
                                    to={`/${language}/news/${item.category}/${item.id}`}
